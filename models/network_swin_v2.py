...
from models.swin.swinv2_utils import Upsample, RSTB, UpsampleOneStep
from models.swin.utils import  PatchUnEmbed, PatchEmbed
import numpy as np
...
class Swin_v2(nn.Module):
    ...
    def forward_feature(self, x, require_grad=True, input_mean=None, input_x_size=None, H=None, W=None, downsample=False):
        ...
        return x[:, :, :self.H*self.upscale, :self.W*self.upscale]
